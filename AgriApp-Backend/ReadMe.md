...
The project is built using **Clean Architecture** principles to ensure strict separation of concerns, high testability, and scalability.
...
    - **Dapper:** For raw SQL performance in analytical reporting.
    - **SQL Server** 
    - **Repository Pattern**		
...
|----------|--------|----------|-------------|------|
| Auth | POST | `/api/v1/auth/login` | User authentication & JWT issuance | Public |
| Products | GET | `/api/v1/products` | Fetch all products | Public |
| Orders | POST | `/api/v1/orders` | Place order (RabbitMQ triggered) | Customer |
| Crops | POST | `/api/v1/crops` | Add new crop | Farmer/Admin |
